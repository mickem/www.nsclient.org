...
# Fixed some exotic passive checks, and security hardening
...
[You can download the new version from GitHub](https://github.com/mickem/nscp/releases/0.18.0){ .md-button }
