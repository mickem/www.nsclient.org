...
carries machine-readable [REUSE](https://reuse.software/) metadata
...
[You can download the new version from GitHub](https://github.com/mickem/nscp/releases/0.14.1){ .md-button }
